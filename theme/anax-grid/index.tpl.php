...
<div id='wrapper'>
    ...
    <div id="loginPanel">
        ...
        if ($user->loggedIn()) {
            $print = "<a href='".$this->url->create('users/id/'.$user->getLoggedInId())."'>Visa profil</a> <a href='".$this->url->create('users/edit')."'>Redigera profil</a> <a href='".$this->url->create('users/logout')."'>Logga ut</a>";
            echo $print;
        } else {
            $print = "<a href='".$this->url->create('users/register')."'>Registrera</a> <a href='".$this->url->create('users/login')."'>Logga in</a>";
            echo $print;
        }
        ?>
    </div>
    ...
    <?php if ($this->views->hasContent('main', 'sidebar')) : ?>
        <div id='wrap-maincontentsidebar'>
